...
### **_ACTIVATE WINDOWS_**
  - Using this exploit in Windows Powershell, you can get rid of that annoying **Acivate Windows** watermark. Open up Windows Powershell and copy this script irm https://get.activated.win | iex and paste it in the terminal. Select the options for your corresponding Windows operating system.
_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
